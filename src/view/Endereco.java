...
public class Endereco extends javax.swing.JFrame {
    ...
    public Endereco() {
        initComponents();
        enderecoController = new EnderecoController(this, btnEditar, btnFechar, btnRemover, btnAdicionar, tableEndereco);
        lerTabela();
    }

    private void lerTabela() {
        enderecoController.listarNaTabela();
    }
    ...
    private void initComponents() {
        ...
        tableEndereco.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Pais", "Estado", "Uf", "Cidade", "Bairro", "Rua", "Numero"
            }
        ) {
