...
public class Funcionario extends javax.swing.JFrame {
    ...
    public Funcionario() {
        initComponents();
        funcionarioController = new FuncionarioController(this, btnEditar, btnFechar, btnRemover, btnAdicionar, tableFuncionario);
        lerFuncionarios();
    }
    ...
    private void btnFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFecharActionPerformed
        funcionarioController.fechar();        // TODO add your handling code here:
    ...
    private void lerFuncionarios() {
        funcionarioController.listarNaTabela();
    }
}
